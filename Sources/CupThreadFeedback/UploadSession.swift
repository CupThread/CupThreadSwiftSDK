...
extension FeedbackClient {
    ...
    public func uploadAttachment(
        ...
        try validateResponse(httpResponse, data: responseData, accepted: [200])

        // The server answers with the finalized object; decode leniently and
        // fall back to slot/local facts for anything missing.
        ...
        return FeedbackAttachment(
            ...
            mimeType: mimeType,
            size: uploaded?.sizeBytes ?? data.count
        )
    }
